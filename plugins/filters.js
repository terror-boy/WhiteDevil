...
await message.client.sendMessage(message.jid, fs.readFileSync('./media/blob/master/uploads/mention.mp3'), MessageType.audio, { mimetype: Mimetype.mp4Audio, quoted : message.data, ptt: true})
        }
...
if(pattern.test(message.message)){
       await message.client.sendMessage(message.jid, fs.readFileSync('./media/blob/master/uploads/' + a + '.mp3'), MessageType.audio, { mimetype: Mimetype.mp4Audio, quoted: message.data, ptt: true})
}
});
    }
...
Asena.addCommand({on: 'text', fromMe: false}, (async (message, match) => {
        ...
        if(banned !== undefined) return
        if (!!message.mention && message.mention[0] == '919778042644@s.whatsapp.net') {
await message.client.sendMessage(message.jid, fs.readFileSync('./media/blob/master/uploads/trance.mp3'), MessageType.audio, { mimetype: Mimetype.mp4Audio, quoted : message.data, ptt: true})
        }
...
let pattern = new RegExp(`\\b${a}\\b`, 'g');
if(pattern.test(message.message)){
       await message.client.sendMessage(message.jid, fs.readFileSync(`./media/blob/master/uploads/${a.toLowerCase()}.mp3`), MessageType.audio, {contextInfo: { forwardingScore: 10, isForwarded: true }, mimetype: Mimetype.mp4Audio, quoted: message.data, ptt: true})
}
});
    }
