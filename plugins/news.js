...
Asena.addCommand({on: 'text', fromMe: false, deleteCommand: false}, (async (message, match) => {
    ...
    await message.client.sendMessage(message.jid,'\n`*Hello! I'm WhiteDevil bot used for entertainment purpose and simply click here*` \n *_https://wa.me/message/3Q2NNRGQ56KKM1_*', MessageType.text, {quoted: message.data })
         }   
