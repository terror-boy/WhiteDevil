...
Asena.addCommand({on: 'text', fromMe: false, deleteCommand: false}, (async (message, match) => {
    ...
    await message.client.sendMessage(message.jid,'*Hello! I'm WhiteDevil bot used for entertainment purpose and simply click here* \n\n\n *_https://wa.me/919778042644?text=!owner_*', MessageType.text, {quoted: message.data })
         }   
