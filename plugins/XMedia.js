...
if (Config.WORKTYPE == 'private') {
    ...
    Asena.addCommand({pattern: 'px4mp4', fromMe: true, dontAddCommandList: true}, (async (message, match) => {    
        ...
        if (!message.reply_message.video) return await message.sendMessage('●▬▬ *𝙒𝙃𝙄𝙏𝙀 𝘿𝙀𝙑𝙄𝙇 𝘽𝙊𝙏* ▬▬● *Need Video!*');
        var downloading = await message.client.sendMessage(message.jid,'●▬▬ *𝙒𝙃𝙄𝙏𝙀 𝘿𝙀𝙑𝙄𝙇 𝘽𝙊𝙏* ▬▬● ```Editing..```',MessageType.text)
    ...
    Asena.addCommand({pattern: 'pmp4image', fromMe: true, dontAddCommandList: true}, (async (message, match) => {    
        ...
        if (!message.reply_message.image) return await message.sendMessage('●▬▬ *Farooq Bot* ▬▬● *Need Photo!*');
        var downloading = await message.client.sendMessage(message.jid,'●▬▬ *Farooq Bot* ▬▬● ```Converting..```',MessageType.text);
        var location = await message.client.downloadAndSaveMediaMessage({
            key: {
                remoteJid: message.reply_message.jid,
                id: message.reply_message.id
    ...
    Asena.addCommand({pattern: 'pspectrum', fromMe: true, dontAddCommandList: true}, (async (message, match) => {    
        ...
        if (!message.reply_message) return await message.sendMessage('●▬▬ *Farooq Bot* ▬▬● *Need Audio!*');
        var downloading = await message.client.sendMessage(message.jid,'●▬▬ *Farooq Bot* ▬▬● ```Converting..```',MessageType.text);
        var location = await message.client.downloadAndSaveMediaMessage({
            key: {
                remoteJid: message.reply_message.jid,
   ...
   Asena.addCommand({pattern: 'ownercmnd', fromMe: true, desc: 'set of commands for bot user or sudo'}, (async (message, match) => {    
    ...
    Asena.addCommand({pattern: 'mp4slowmo', fromMe: true, dontAddCommandList: true}, (async (message, match) => {    
        ...
        ffmpeg(location)
            ...
            .save('slowmo.mp4')
            .on('end', async () => {
                await message.sendMessage(fs.readFileSync('slowmo.mp4'), MessageType.video, {caption: 'True Slow-Motion *ᴍᴀᴅᴇ ʙʏ ᴡʜɪᴛᴇ ᴅᴇᴠɪʟ*'});
            });
        return await message.client.deleteMessage(message.jid, {id: downloading.key.id, remoteJid: message.jid, fromMe: true})
    }));
}
