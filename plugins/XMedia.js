...
if (Config.WORKTYPE == 'private') {
    ...
    Asena.addCommand({pattern: 'pmp4image', fromMe: true, dontAddCommandList: true}, (async (message, match) => {    
        ...
        if (!message.reply_message.image) return await message.sendMessage('●▬▬ *𝙒𝙃𝙄𝙏𝙀 𝘿𝙀𝙑𝙄𝙇 𝘽𝙊𝙏* ▬▬● *Need Photo!*');
        var downloading = await message.client.sendMessage(message.jid,'●▬▬ *𝙒𝙃𝙄𝙏𝙀 𝘿𝙀𝙑𝙄𝙇 𝘽𝙊𝙏* ▬▬● ```Converting..```',MessageType.text);
        var location = await message.client.downloadAndSaveMediaMessage({
            key: {
                remoteJid: message.reply_message.jid,
                id: message.reply_message.id
    ...
    Asena.addCommand({pattern: 'pspectrum', fromMe: true, dontAddCommandList: true}, (async (message, match) => {    
        ...
        if (!message.reply_message) return await message.sendMessage('●▬▬ *𝙒𝙃𝙄𝙏𝙀 𝘿𝙀𝙑𝙄𝙇 𝘽𝙊𝙏* ▬▬● *Need Audio!*');
        var downloading = await message.client.sendMessage(message.jid,'●▬▬ *𝙒𝙃𝙄𝙏𝙀 𝘿𝙀𝙑𝙄𝙇 𝘽𝙊𝙏* ▬▬● ```Converting..```',MessageType.text);
        var location = await message.client.downloadAndSaveMediaMessage({
            key: {
                remoteJid: message.reply_message.jid,
