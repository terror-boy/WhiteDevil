...
if (Config.LANG == 'ID') language = 'Indonasian', FMSG = '\n\nSemoga harimu menyenangkan 💖\n\n```Terima kasih telah menggunakan WhiteDevil 💕```\n*WhiteDevil , Dibuat oleh TERROR BOY*', MSG = '*◄━━━━━━━⦁⦁◯⦁⦁━━━━━━━━►*\n   *⦁◊═⦁ WhiteDevil ⦁═◊⦁*\n*◄━━━━━━━⦁⦁◯⦁⦁━━━━━━━━►*\n\nHai pengguna,\n*'+wishid+'*\n\n*◆ INFORMASI BOT ◆*\n\n```▣ Pengembang:``` *TERROR BOY*\n```▣ Pemilik:``` *'+Config.OWNER+'*\n```▣ Hubungi Pemilik:``` *wa.me/'+Config.OWNERNUM+'*\n```▣ Bahasa:``` *'+language+'*\n```▣ Auto Bio:``` *'+auto_bio+'*\n```▣ Antilink:``` *'+anti_link+'*\n```▣ Jenis Pekerjaan:``` *'+Config.WORKTYPE+'*\n\n∎ ⇓ *Perintah* ⇓ ∎\n\n'
    ...
    Asena.addCommand({pattern: 'whitedevil ?(.*)', fromMe: td, dontAddCommandList: true}, (async (message, match) => {
